...
<head>
    ...
    <title>JeeDee Advertising | Halaman Admin</title>
    @yield('css')
</head>
    ...
    <div class="sidebar">
        <div class="sidebar-brand-container">
            <a href="#" class="sidebar-brand">
                <img src="{{ asset('/assets/images/logo.png') }}" alt="brand-image" class="me-2">
                <p class="color-dark mb-0" style="font-size: 1em; font-weight: bold;">JeeDee</p>
            </a>
        </div>
